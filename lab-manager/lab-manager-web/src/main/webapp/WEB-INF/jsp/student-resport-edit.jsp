...
<div style="padding:10px 10px 10px 10px">
	...
	<div style="padding:5px">
	    <a href="javascript:void(0)" class="easyui-linkbutton" onclick="submitForm()">修改实验报告</a>
	</div>
</div>
<script type="text/javascript">
	...
	function submitForm(){
		...
		$.post("/student/resport/update",$("#itemeEditForm").serialize(), function(data){
			if(data.status == 200){
				$.messager.alert('提示','学生修改实验报告成功!','info',function(){
