...
<head>
    ...
    <title>注册-个人用户</title>
    <link rel="stylesheet" type="text/css" href="/css/sso/headerfooter.css" />
	...
	<script type="text/javascript" src="/js/sso/passport.common.js?v20140531"></script>
	<script type="text/javascript" src="/js/sso/jquery.alerts.js"></script>
	<script type="text/javascript" src="/js/sso/png.js?v20140521"></script>
</head>
<body>
	<!-- header -->
	<div class="header">
		<!-- <a href="http://www.e3mall.cn"><img src="/images/sso/logo.png" border="0" /> -->
		<span>欢迎注册</span></a>
	</div>

	<!--mainStart-->
	<link rel="stylesheet" type="text/css" href="/css/sso/reg.css?v20140432" />
	<script type="text/javascript" src="/js/sso/allMail.js?v20140430"></script>
	<script type="text/javascript" src="/js/sso/reg.js?v20150122"></script>
	<!-- reg_main -->
...
<script type="text/javascript">
	var REGISTER={
		...
		beforeSubmit:function() {
				//检查用户是否已经被占用
				$.ajax({
	            	url : REGISTER.param.surl + "/user/register/check/"+escape($("#regName").val())+"/1?r=" + Math.random(),
	            	success : function(data) {
	            		if (data.data) {
	            			//检查手机号是否存在
	            			$.ajax({
	            				url : REGISTER.param.surl + "/user/register/check/"+$("#phone").val()+"/2?r=" + Math.random(),
				            	success : function(data) {
				            		if (data.data) {
					            		REGISTER.doSubmit();
				            		} else {
